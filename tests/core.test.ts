...
describe('storage', () => {
  it('round-trips a saved game and settings', () => {
    ...
    const data: StoredData = {
      version: 1,
      settings: { theme: 'dark', lastSize: 4, lastMode: 'standard', autoOn: false, autoSpeed: 180, autoDepth: 0, autoPowerups: true, rngManip: false, backtrackEnabled: true },
      games: {},
      nextId: 100,
    };
  ...
  it('clearGames wipes saved games', () => {
    ...
    const data: StoredData = {
      version: 1,
      settings: { theme: 'light', lastSize: 4, lastMode: 'standard', autoOn: false, autoSpeed: 180, autoDepth: 0, autoPowerups: true, rngManip: false, backtrackEnabled: true },
      games: {},
      nextId: 1,
    };
    putGame(data, s.state);
