...
// The 256-bit key is a per-game seed XOR-ed with KEY_MATERIAL.
// Without source: reproducing the stream is infeasible. With source + seed: fully predictable.
// Stream state (calls) is persisted so reloaded games resume exactly.

// Source-embedded key material (32 bytes).
